...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.post("/api/payment-stages/:id/generate-link", authenticateToken, async (req: AuthRequest, res) => {
    try {
      ...
      console.log("Creating MercadoPago payment for stage:", stageId, paymentData);
      ...
      const updated = await storage.updatePaymentStage(stageId, {
        paymentLink: mercadoPagoResponse.init_point || mercadoPagoResponse.sandbox_init_point,
      ...
      console.log("Payment link generated successfully:", {
        stageId,
        mercadoPagoId: mercadoPagoResponse.id,
        paymentLink: mercadoPagoResponse.init_point
      });
