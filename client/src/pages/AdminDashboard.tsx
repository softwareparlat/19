    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        ...
        <p className="text-xs text-muted-foreground mt-1">
          {currentConfig?.hasAccessToken ? "✅ Configurado" : "❌ No configurado"}
        </p>
      </div>
      ...
      <div>
        ...
        <Input
          ...
          placeholder="E4vFGfTb2SC..."
          data-testid="input-mp-client-secret"
        />
        <p className="text-xs text-muted-foreground mt-1">
          {currentConfig?.hasClientSecret ? "✅ Configurado" : "❌ No configurado"}
        </p>
      </div>
      ...
      <div>
        ...
        <Input
          ...
          placeholder="softwarepar_webhook_2025"
          data-testid="input-mp-webhook-secret"
        />
        <p className="text-xs text-muted-foreground mt-1">
          {currentConfig?.hasWebhookSecret ? "✅ Configurado" : "❌ No configurado"}
        </p>
      </div>
